...
const products = [
  { id: 1, name: "Black and White Gradient Jacket", video: "https://storage.googleapis.com/a1aa/videos/gradient_jacket.mp4", price: 299.99, description: "A stylish black and white gradient jacket perfect for any occasion." },
  { id: 2, name: "Black and White Gradient Shorts", video: "https://storage.googleapis.com/a1aa/videos/gradient_shorts.mp4", price: 149.99, description: "Comfortable black and white gradient shorts to complete your look." },
